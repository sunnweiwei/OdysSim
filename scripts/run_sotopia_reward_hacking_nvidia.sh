...
export SOTOPIA_TRAIN_REWARD_MODE="${SOTOPIA_TRAIN_REWARD_MODE:-eval_avg}"
...
export PPO_MICRO_BATCH_SIZE_PER_GPU="${PPO_MICRO_BATCH_SIZE_PER_GPU:-null}"
...
SOTOPIA_TRAIN_REWARD_MODE=$SOTOPIA_TRAIN_REWARD_MODE
